...
class mcollective::client::plugins {
    ...
    file { "${bin_dir}/mc-package": source => "${s_base}/agent/service/mc-package" }
    file { "${bin_dir}/mc-nrpe":    source => "${s_base}/agent/service/mc-nrpe" }
    file { "${bin_dir}/mc-puppetd": source => "${s_base}/agent/service/mc-puppetd" }
